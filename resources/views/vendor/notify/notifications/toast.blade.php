@if (session()->get('notify.model') === 'toast')
    <div class="notify fixed inset-0 flex items-end px-4 py-6 pointer-events-none sm:p-6 sm:items-start">
        <div
            ...
            @class([
                'pointer-events-auto w-full max-w-sm overflow-hidden shadow-lg rounded-lg border-r-4',
